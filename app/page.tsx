    ...
    <main className={styles.main}>
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <span className={styles.eyebrow}>Ação Exclusiva · Válido até 10/07</span>
          ...
          <p className={styles.subtitle}>
            ...
            Crédito válido até <strong>10 de julho de 2026</strong>.
          </p>
            ...
            {isEsgotado ? (
              ...
              <>
                ...
                <span className={styles.slotsLabel}>
                  {slotsLeft === 1 ? 'vaga restante' : 'vagas restantes'}
                </span>
              </>
            )}
          </div>
      ...
      <section className={styles.how}>
        ...
        <div className={styles.steps}>
          <div className={styles.stepCard}>
            ...
            <h3>Cadastre-se</h3>
            <p>Preencha seu nome, telefone e e-mail no formulário.</p>
          </div>
          <div className={styles.stepCard}>
            <span className={styles.stepIcon}>💳</span>
            <h3>Pague R$49,90</h3>
            <p>Nossa equipe envia o link de pagamento pelo WhatsApp.</p>
          </div>
          <div className={styles.stepCard}>
            <span className={styles.stepIcon}>🍕</span>
            <h3>Use R$100 na Neon</h3>
            <p>Venha nos visitar e use seu crédito até 10/07.</p>
          </div>
        </div>
      </section>
      ...
      {step === 'form' && (
        <section className={styles.formSection} id="form">
          <div className={styles.formCard}>
            ...
            <p className={styles.formSubtitle}>Após o cadastro, você receberá o link de pagamento pelo WhatsApp.</p>
            ...
            <button
              ...
              disabled={loading}
            >
              {loading ? 'Cadastrando...' : 'Cadastrar e ir para o WhatsApp'}
            </button>
        ...
        <section className={styles.successSection}>
          <div className={styles.successCard}>
            ...
            <p className={styles.successInfo}>
              ...
              Após o pagamento, seu crédito de <strong>R$100</strong> estará confirmado.
            </p>
      ...
      <footer className={styles.footer}>
        <p>© 2026 Neon Pizzaria · Ação limitada a {config?.max_slots ?? 10} participantes</p>
      </footer>
    </main>
  )
}
